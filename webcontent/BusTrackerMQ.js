    ...
    constructor() {
        ...
        let onload = function() {
            ...
            function generateReport() {
                fetch("http://localhost:3000/BusSpeed?spd=" + $("#route").val())
            ...
            function doAjaxRequest() {
                update++;
                $("#update").html(update);
                fetch("http://localhost:3000/Businfo?key=" + key + "&rt=" + $("#route").val())
                    .then(handleSuccess)
                    .catch(handleError);
            ...
            function handleSuccess(response) {
                ...
                response.json().then(buses => {
                    if (buses.hasOwnProperty("status")) {
                        ...
                        message.hide();
                        ReactDOM.render(<BusTable data={buses["bustime-response"]["vehicle"]}/>, document.getElementById("table1"));
                        table.show();
            ...
            function handleDBSuccess(response) {
                ...
                response.json().then(buses => {
                    ...
                    if (buses.length > 0) {
                        message.hide();
                        ReactDOM.render(<BusTable data={buses}/>, document.getElementById("table1"));
                        table.show();
