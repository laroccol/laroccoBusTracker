        ...
        return <ul className='list-group'>
            { // Javascript in the middle of JSX needs to be delimited with {}
              ...
              // augment the Courselist object's 'props' attribute.
                this.props.items.map((course, index) =>
                    <li key={index} className={'list-group-item ' + this.props.cssColor} >
...
// onLoad handling is usually used to perform initialization
    static onLoad() {
        ...
        let fallTrack = {
                        ...
                        term:'fall',
                        courses:[
                            {id:'se2030',desc:'tools and practices'},
                            {id:'cs2911',desc:'network protocols'},
                            {id:'ph2030',desc:'modern physics'},
                            {id:'ma2310',desc:'discrete math'}
                        ]
                    };
        ...
        let winterTrack = {
            ...
            term:'winter',
            courses:[
                {id:'se2840',desc:'web app dev'},
                {id:'cs2711',desc:'computer org'},
                {id:'se2811',desc:'software component design'},
                {id:'ch200',desc:'general chemistry'}
            ]
        };
        ...
        $('#button').click( () => {
            ...
            $('#quarter').html(fallTrack.term);

            // NOTE: We are passing 'fallTrack.courses' to Courselist
            //   via the 'argument' items (an arbitrary identifier)
            ReactDOM.render(<Courselist items={fallTrack.courses} cssColor={'list-group-item-danger'}/>,
                document.getElementById("courselist"));
            ReactDOM.render(<Courselist items={winterTrack.courses} cssColor={'list-group-item-info'} />,
